    ...
    <>
      <form>
        ...
        <div className="flex justify-center">
          <button onClick={randomMeme} className="rounded-md p-2 flex flex-row items-center justify-center bg-gradient-to-r from-[#672280]  to-[#A626D3] text-white text-lg w-[80%] hover:scale-105">
