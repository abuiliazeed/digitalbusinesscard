  ...
  return (
    <>
      <div className="bg-black flex flex-col justify-center items-center p-4">
        ...
        <div onClick={handleCountdown} className="rounded-full bg-white w-20 h-20 flex items-center justify-center hover:scale-105 hover:cursor-pointer">
          <h1 className="text-[60px] font-bold text-center">-</h1>
        </div>
        ...
        <div onClick={handleCountup} className="rounded-full bg-white w-20 h-20 flex items-center justify-center  hover:scale-105 hover:cursor-pointer">
          <h1 className="text-[60px] font-bold text-center">+</h1>
        </div>
